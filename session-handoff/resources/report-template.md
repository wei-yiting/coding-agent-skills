...
1. [handoff-20250318-143022] feature/etl-pipeline
...
```
2. ⚠️ [handoff-20250312-091500] feature/qdrant-setup（超過 5 天未更新）
   - 專案：lexlab-x
...
```
3. [handoff-20250318-160000] feature/chunker-refactor
   - 專案：lexlab-x
...
1. [handoff-20250315-091500] feature/qdrant-setup

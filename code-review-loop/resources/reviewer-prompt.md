...
Match each smell below against the diff. Two rules bind this baseline:
...
- **Always a judgement call.** Each smell is a labelled heuristic ("possible Feature
  Envy"), never a hard violation. Report baseline smells at Minor or Suggestion
  severity, name the smell, and quote the offending hunk. Skip anything tooling
